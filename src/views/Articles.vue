<template>
    ...
    <div class="flex flex-col items-center md:border-4 border-2 border-black dark:border-gray-500 mx-4 md:mx-8 my-4 md:my-8 shadow-md hover:shadow-2xl rounded-md dark:text-gray-200" v-for="article in articles" :key="article">
