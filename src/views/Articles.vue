<template>
    ...
    <div class="flex flex-col items-center md:border-4 border-2 border-black md:mx-8 my-4 md:my-8 shadow-md hover:shadow-2xl rounded-md border-x-0" v-for="article in articles" :key="article">
